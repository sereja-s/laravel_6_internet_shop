<div class="col-sm-6 col-md-4">
	<div class="thumbnail">
		...
		<div class="caption">
			...
			<!-- Laravel: интернет магазин ч.35: Eloquent: whereHas -->
			<!-- отображаем наборы свойств в карточке товара(если они есть) -->
			...
			<form action="{{ route('basket-add', $sku) }}" method="POST">
				...
				<a href="{{ route('sku',
                    ...
                    $sku->product->category->code, $sku->product->code, $sku->id]) }}" class="btn btn-default" role="button">@lang('main.more')</a>

				<!-- директива добавляет токен -->
				@csrf
			</form>
			</p>
		</div>
